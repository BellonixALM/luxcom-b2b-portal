...
const FALLBACK_DATA = {
  ...
  products: [
    ...
    },
    {
      id: "LUX-COPPER-12",
      category: "copper-pipes",
      name: "Труба мідна кондиціонерна 1/2\" (12.7х0.81 мм) Halcor (Бухта 15м)",
      sku: "COPPER-12-15M",
      retailPrice: 3200,
      b2bPrice: 2624,
      unit: "бухта",
      stock: 210,
      minOrder: 1,
      specs: { "Діаметр": "1/2\" (12.7 мм)", "Товщина стінки": "0.81 мм", "Виробник": "Halcor (Греція)" },
      badge: "В наявності",
      image: "https://images.prom.ua/2945432410_w321_h266_truba-midna-ta.jpg"
    },
    {
      id: "LUX-COPPER-58",
      category: "copper-pipes",
      name: "Труба мідна кондиціонерна 5/8\" (15.87х1.0 мм) Halcor (Бухта 15м)",
      sku: "COPPER-58-15M",
      retailPrice: 4500,
      b2bPrice: 3690,
      unit: "бухта",
      stock: 140,
      minOrder: 1,
      specs: { "Діаметр": "5/8\" (15.87 мм)", "Товщина стінки": "1.0 мм", "Виробник": "Halcor (Греція)" },
      badge: "Преміум",
      image: "https://images.prom.ua/2945432410_w321_h266_truba-midna-ta.jpg"
    },
    {
    ...
    },
    {
      id: "LUX-INSUL-10-06",
      category: "insulation",
      name: "Теплоізоляція для мідних труб K-Flex ST 10x06 мм (2м)",
      sku: "K-FLEX-ST-10O06",
      retailPrice: 52,
      b2bPrice: 42.6,
      unit: "шт (2м)",
    ...
    },
    {
      id: "LUX-FREON-R410A",
      category: "freon-materials",
      name: "Хладагент / Фреон R410A у балоні 11.3 кг (DuPont / Honeywell)",
      sku: "FREON-R410A-11KG",
      retailPrice: 4200,
      b2bPrice: 3444,
      unit: "балон",
      stock: 120,
    ...
    {
      id: "LUX-BRACKET-450",
      category: "brackets-fix",
      name: "Кронштейн для зовнішнього блоку К1 450х450 мм (Полімерне покриття 2.0мм)",
      sku: "BRACKET-K1-450",
      retailPrice: 420,
      b2bPrice: 344.4,
      unit: "пара",
    ...
    {
      id: "LUX-PUMP-FLOWITA",
      category: "drainage-pumps",
      name: "Дренажна помпа проточна Sauermann Si-30 (15 л/год)",
      sku: "PUMP-SAUERMANN-SI30",
      retailPrice: 2850,
      b2bPrice: 2337,
      unit: "шт",
      stock: 45,
